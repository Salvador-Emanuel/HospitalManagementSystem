        ...
        try {
            ...
            while (result.next()) {
                pData = new PatientsData(result.getInt("id"), result.getInt("patient_id"),
                        ...
                        result.getLong("mobile_number"),result.getString("address"),
            ...
            final TableCell<PatientsData, String> cell = new TableCell<PatientsData, String>() {
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        editButton.setStyle("-fx-background-color: linear-gradient(to bottom right, #ea665d, #c71d28);"
                                + "-fx-cursor: hand;\n"
                                + "-fx-text-fill: #fff;\n"
                                + "-fx-font-size: 14px;\n"
                                + "-fx-font-family: Arial;");
                        
                        removeButton.setStyle("-fx-background-color: linear-gradient(to bottom right, #ea665d, #c71d28);"
                                + "-fx-cursor: hand;\n"
                                + "-fx-text-fill: #fff;\n"
                                + "-fx-font-size: 14px;\n"
                                + "-fx-font-family: Arial;");
